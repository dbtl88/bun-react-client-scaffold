...
export default class extends Generator {
  async prompting() {
    ...
    const configPropertiesToCheck = [
      ...
      "localApiDomain",
      "sandboxApiDomain",
      "sandboxApiForCloudFront",
      "prodApiForCloudFront",
      "prodApiDomain",
      "sandboxDomain",
      "prodDomain",
      "certificateArn",
  ...
  writing() {
    ...
    this.fs.copyTpl(this.templatePath("cdk-pipeline"), this.destinationPath(), {
      ...
      sandboxApiForCloudFront: this.answers.sandboxApiForCloudFront,
      prodApiForCloudFront: this.answers.prodApiForCloudFront,
      sandboxDomain: this.answers.sandboxDomain,
      prodDomain: this.answers.prodDomain,
